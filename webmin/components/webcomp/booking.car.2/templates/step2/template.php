                ...
                <div class="panel-collapse collapseOneBody" role="tabpanel" aria-labelledby="headingOne">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 padding_top has-error">
                                <label for="address">Mã khuyến mãi:</label>
                                <input type="text" class="form-control" name="makhuyenmai" placeholder="Ví dụ: 0978625621" id="address" value="<?=$_SESSION["BOOKING"]['CUSTOMER']['MA_KHUYEN_MAI']?>"> </div>
    ...
    function saveCustomer(){
        $.ajax({
            ...
            success: function(data){
                if(data.success){
                    window.location.href = "/dat-xe-2/thanh-toan/"
                }else{
