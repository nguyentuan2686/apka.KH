...
require_once($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/start.php");
//определяем язык
...
if(file_exists($_SERVER["DOCUMENT_ROOT"]."/webmin/init.php"))
	include_once($_SERVER["DOCUMENT_ROOT"]."/webmin/init.php");
