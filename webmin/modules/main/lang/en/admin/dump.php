...
$MESS["TAB_ADVANCED_DESC"] = "Expert backup creation parameters";
$MESS["MODE_DESC"] = "You are about to create the full backup copy of the <b>current site</b> (if multiple sites configuration), <b>system kernel</b> and <b>database</b> (MySQL only) which can be uset for system restore and migration to other server. Select the desired mode and, if required, configure additional parameters using the &quot;<b>Advanced</b>&quot; tab.";
