...
while($db_res = $rsData->NavNext(true, "a_"))
{
	...
	$row->AddField("USER_ID", ($a_USER_ID > 0 ) ? "<a href=\"/webmin/admin/user_edit.php?ID=".$a_USER_ID."&lang=".LANG."\">[".$a_USER_ID."] ".$a_USER_NAME." ".$a_LAST_NAME." (".$a_LOGIN.")</a>" : GetMessage("MAIN_AGENT_SYSTEM_USER"));
