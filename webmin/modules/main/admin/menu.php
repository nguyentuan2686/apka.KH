...
if($USER->CanDoOperation('view_other_settings'))
{
	...
	{
		if($adminMenu->IsSectionActive("menu_module_settings") || ($APPLICATION->GetCurPage() == "/webmin/admin/settings.php" && $_REQUEST["mid_menu"]<>""))
		{
			$adminPage->Init();
			foreach($adminPage->aModules as $module)
			{
				if($module <> "main")
				{
					...
					$ifile = $_SERVER["DOCUMENT_ROOT"]."/webmin/modules/".$module."/install/index.php";
					$ofile = $_SERVER["DOCUMENT_ROOT"]."/webmin/modules/".$module."/options.php";
