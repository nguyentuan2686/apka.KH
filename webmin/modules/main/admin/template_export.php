...
if((!$USER->CanDoOperation('edit_other_settings') && !$USER->CanDoOperation('view_other_settings')) || !check_webmin_sessid())
...
if (strlen($strError) > 0)
{
	...
	require($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/include/epilog_admin_before.php");
}
