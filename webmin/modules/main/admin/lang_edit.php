...
$aMenu = array(
	array(
		...
		"LINK"	=> "/webmin/admin/lang_admin.php?lang=".LANGUAGE_ID."&set_default=Y",
...
if ($ID>0)
{
	...
	$aMenu[] = array(
		...
		"LINK"	=> "/webmin/admin/lang_edit.php?lang=".LANGUAGE_ID,
	...
	if($isAdmin)
	{
		$aMenu[] = array(
			...
			"LINK"	=> "/webmin/admin/lang_edit.php?lang=".LANGUAGE_ID."&amp;COPY_ID=".urlencode($LID),
			"TITLE"	=> GetMessage("MAIN_COPY_RECORD_TITLE"),
			"ICON"	=> "btn_copy"
			);
		$aMenu[] = array(
			"TEXT"	=> GetMessage("MAIN_DELETE_RECORD"),
			"LINK"	=> "javascript:if(confirm('".GetMessage("MAIN_DELETE_RECORD_CONF")."')) window.location='/webmin/admin/lang_admin.php?ID=".urlencode(urlencode($LID))."&lang=".LANGUAGE_ID."&".bitrix_sessid_get()."&action=delete';",
