...
{
	var changed = false;
	var url = '/webmin/admin/captcha.php?Preview=Y&captcha_sid=<?echo $CAPTCHA_CODE?>';
	var ctl, b;
...
<tr>
	...
	<td  with="30%" rowspan="<?echo count($arSettings)+1?>">
		<?for($i=0;$i < 10; $i++):?>
			<img id="CAPTCHA_<?echo $i?>" src="/webmin/admin/captcha.php?Preview=Y&amp;captcha_sid=<?echo $CAPTCHA_CODE?>&amp;i=<?echo $i?>&amp;j=0" width="180" height="40" alt="CAPTCHA" /><br>
		<?endfor?>
	</td>
</tr>
<?foreach($arSettings as $key => $value):?>
