...
$aMenu = array(
	array(
		...
		"LINK"	=> "/webmin/admin/template_admin.php?lang=".LANGUAGE_ID."&set_default=Y",
...
if (strlen($ID)>0 && $edit_php)
{
	...
	$aMenu[] = array(
		...
		"LINK"	=> "/webmin/admin/template_edit.php?lang=".LANGUAGE_ID,
	...
	$aMenu[] = array(
		...
		"LINK"	=> "/webmin/admin/template_admin.php?lang=".LANGUAGE_ID."&ID=".urlencode($ID)."&action=copy&".bitrix_sessid_get(),
	...
	$aMenu[] = array(
		...
		"LINK"	=> "javascript:if(confirm('".GetMessage("MAIN_DELETE_RECORD_CONF")."')) window.location='/webmin/admin/template_admin.php?ID=".urlencode(urlencode($ID))."&lang=".LANGUAGE_ID."&".bitrix_sessid_get()."&action=delete';",
...
<script type="text/javascript" src="/webmin/js/main/template_edit.js?v=<?=@filemtime($_SERVER['DOCUMENT_ROOT'].'/webmin/js/main/template_edit.js')?>"></script>
