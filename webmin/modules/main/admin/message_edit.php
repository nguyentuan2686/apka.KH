...
$aMenu = array(
	array(
		...
		"LINK"	=> "/webmin/admin/message_admin.php?lang=".LANGUAGE_ID."&set_default=Y",
...
if (intval($ID)>0 && $COPY_ID<=0)
{
	$aMenu[] = array(
		...
		"LINK"	=> "/webmin/admin/type_edit.php?EVENT_NAME=".htmlspecialchars($str_EVENT_NAME)."&amp;lang=".LANGUAGE_ID,
	...
	$aMenu[] = array(
		...
		"LINK"	=> "/webmin/admin/message_edit.php?lang=".LANGUAGE_ID,
	...
	$aMenu[] = array(
		...
		"LINK"	=> "/webmin/admin/message_edit.php?lang=".LANGUAGE_ID.htmlspecialchars("&COPY_ID=").$ID,
	...
	$aMenu[] = array(
		...
		"LINK"	=> "javascript:if(confirm('".GetMessage("MAIN_DELETE_RECORD_CONF")."')) window.location='/webmin/admin/message_admin.php?ID=".$ID."&lang=".LANGUAGE_ID."&".bitrix_sessid_get()."&action=delete';",
