...
<?
	...
	{
		$path = $_SERVER["DOCUMENT_ROOT"]."/webmin/modules/".$arWizardName[0]."/install/wizards/".$arWizardName[1]."/".$arWizardName[2];

		CopyDirFiles(
			$_SERVER["DOCUMENT_ROOT"]."/webmin/modules/".$arWizardName[0]."/install/wizards/".$arWizardName[1]."/".$arWizardName[2],
			$_SERVER["DOCUMENT_ROOT"]."/webmin/wizards/".$arWizardName[1]."/".$arWizardName[2],
			true,
			true,
			false,
			""
