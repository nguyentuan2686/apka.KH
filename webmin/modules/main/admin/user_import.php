...
//Download sample
$filename = $_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/admin/sample.csv";
...
?>
	<tr>
		...
		<td>
			...
			?>
			<?if (is_file($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/admin/sample.csv")):?>
...
?>
	...
	<tr>
		...
		<td>
			...
			&nbsp;<a href="/webmin/admin/ldap_server_edit.php?lang=<?=LANGUAGE_ID?>"><?=GetMessage("USER_IMPORT_NEW_LDAP_SERVER")?></a>
		</td>
	</tr>
	<?endif?>
...
<?elseif ($tabStep == 2 && $dataSource == "ldap"):?>
	...
	<tr>
		...
		<td width="50%">
			...
			&nbsp;<a href="/webmin/admin/ldap_server_edit.php?lang=<?=LANGUAGE_ID?>&back_url=<?=urlencode('/webmin/admin/user_import.php?lang='.$lang.'&dataSource=ldap&tabStep=2')?>"><?=GetMessage("USER_IMPORT_NEW_LDAP_SERVER")?></a>
		</td>
	</tr>
	<tr id="predef">
