	...
	$arIcons = array(
		array(
			...
			"URL"=> 'javascript:'.$GLOBALS['APPLICATION']->GetPopupLink(Array(
				"URL"=> "/webmin/admin/public_file_edit.php?bxpublic=Y&lang=".LANGUAGE_ID."&path=".$encCurrentFilePath."&site=".SITE_ID."&back_url=".$encUri."&templateID=".$encSiteTemplateId,
		...
		array(
			...
			"URL"=>'javascript:'.$GLOBALS['APPLICATION']->GetPopupLink(Array(
				"URL"=>"/webmin/admin/public_file_edit.php?bxpublic=Y&lang=".LANGUAGE_ID."&noeditor=Y&path=".$encCurrentFilePath."&site=".SITE_ID."&back_url=".$encUri,
		...
		array(
			...
			"URL"=> 'javascript:'.$APPLICATION->GetPopupLink(Array(
				"URL"=>"/webmin/admin/public_file_property.php?lang=".LANGUAGE_ID."&site=".SITE_ID."&path=".$encCurrentFilePath."&back_url=".$encUri,
