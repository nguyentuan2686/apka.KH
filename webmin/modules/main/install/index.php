...
Class main extends CModule
{
	...
	function InstallDB()
	{
		...
		$errors = $DB->RunSQLBatch($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/install/".$DBType."/install.sql");
		if ($errors !== false)
		{
	...
	function UnInstallDB()
	{
		...
		$errors = $DB->RunSQLBatch($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/install/".$DBType."/uninstall.sql");
		if ($errors !== false)
		{
			$APPLICATION->ThrowException(implode("", $errors));
			return false;
	...
	{
		CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/install/webmin", $_SERVER["DOCUMENT_ROOT"]."/webmin", true, true);
		CopyDirFiles($_SERVER['DOCUMENT_ROOT']."/webmin/modules/main/install/admin", $_SERVER['DOCUMENT_ROOT']."/webmin/admin");
		CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/install/tools", $_SERVER["DOCUMENT_ROOT"]."/webmin/tools", true, true);
		CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/install/images", $_SERVER["DOCUMENT_ROOT"]."/webmin/images", true, true);
		CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/install/js", $_SERVER["DOCUMENT_ROOT"]."/webmin/js", true, true);
		CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/install/themes", $_SERVER["DOCUMENT_ROOT"]."/webmin/themes", true, true);
		CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/install/sounds", $_SERVER["DOCUMENT_ROOT"]."/webmin/sounds", true, true);
		CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/install/components/webmin", $_SERVER["DOCUMENT_ROOT"]."/webmin/components/webmin", true, true);
		CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/install/gadgets/webmin", $_SERVER["DOCUMENT_ROOT"]."/webmin/gadgets/webmin", true, true);
		CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/install/image_uploader", $_SERVER["DOCUMENT_ROOT"]."/webmin/image_uploader", true, true);
	...
	{
		DeleteDirFiles($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/install/webmin/", $_SERVER["DOCUMENT_ROOT"]."/webmin");
		DeleteDirFilesEx("/webmin/js/");
		DeleteDirFilesEx("/webmin/admin/");
		DeleteDirFilesEx("/webmin/components/webmin");
		DeleteDirFilesEx("/webmin/gadgets/webmin");
		DeleteDirFilesEx("/webmin/templates/");
		DeleteDirFilesEx("/webmin/tools/");
		DeleteDirFilesEx("/webmin/themes/");
		DeleteDirFilesEx("/webmin/images/");
