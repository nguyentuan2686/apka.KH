...
class WizardTemplate extends CWizardTemplate
{
	function GetLayout()
	{
		...
		else
		{
			...
			elseif (file_exists($_SERVER["DOCUMENT_ROOT"]."/webmin/images/install/".LANGUAGE_ID."/logo.gif"))
				$logoImage = '<img src="/webmin/images/install/'.LANGUAGE_ID.'/logo.gif" alt="" />';
			elseif (file_exists($_SERVER["DOCUMENT_ROOT"]."/webmin/images/install/en/logo.gif"))
				$logoImage = '<img src="/webmin/images/install/en/logo.gif" alt="" />';
		}
		...
		else
		{
			...
			elseif (file_exists($_SERVER["DOCUMENT_ROOT"]."/webmin/images/install/".LANGUAGE_ID."/box.jpg"))
				$boxImage = '<img src="/webmin/images/install/'.LANGUAGE_ID.'/box.jpg" alt="" />';
			elseif (file_exists($_SERVER["DOCUMENT_ROOT"]."/webmin/images/install/en/box.jpg"))
				$boxImage = '<img src="/webmin/images/install/en/box.jpg" alt="" />';
		}
		...
		$jsCode = "";
		$jsCode = file_get_contents($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/install/wizard/script.js");
	...
	<head>
		...
		<style type="text/css">
			...
			#container
			{
				padding-top:6px;
				height:100%;
				background: transparent url(/webmin/images/install/bg_top.gif) repeat-x;
				box-sizing:border-box;
				-moz-box-sizing:border-box;
				-webkit-box-sizing: border-box;
				-khtml-box-sizing: border-box;
			...
			td.wizard-title
			{
				background:#e3f0f9 url(/webmin/images/install/top_gradient_fill.gif) repeat-x; 
				height:77px; 
				color:#19448a; 
				font-size:140%; 
			}
			...
			{
				background:#eaeaea url(/webmin/images/install/menu_fill.gif) repeat-x;
				height:40px;
				color:#c0c0c0;
			}
			...
			{
				background:#b41d07 url(/webmin/images/install/menu_fill_selected.gif) repeat-x;
				color:white;
			}
			...
			#menu td.menu-end
			{
				background: url(/webmin/images/install/menu_end.gif) repeat-x;
				width:11px;
			}

			#menu tr.selected td.menu-end
			{
				background: url(/webmin/images/install/menu_end_selected.gif) repeat-x;
				width:11px;
			}
			...
			input.wizard-prev-button {background: #ffe681 url(/webmin/images/install/prev.gif); border:none; width:116px; height:31px; font-weight:bold; padding-bottom:4px; cursor:pointer; cursor:hand;}
			input.wizard-next-button {background: #ffe681 url(/webmin/images/install/next.gif); border:none; width:116px; height:31px; font-weight:bold; padding-bottom:4px; cursor:pointer; cursor:hand;}

			form {margin:0; padding:0;}
			#step-error {color:red; padding:4px 4px 4px 25px;margin-bottom:4px; background:url(/webmin/images/install/error.gif) no-repeat;}
			small{font-size:85%;}
...
<div id="container">
	...
	<table id="main-table" align="center">
		<tr>
			<td width="10" height="10"><img src="/webmin/images/install/corner_top_left.gif" width="10" height="10" alt="" /></td>
			<td width="100%">
			...
			<td width="10" height="10"><img src="/webmin/images/install/corner_top_right.gif" width="10" height="10" alt="" /></td>
		</tr>
		<tr>
					...
					<tr>
						...
						<td width="535" valign="top">
							...
							<table width="100%" height="77" cellpadding="0" cellspacing="0">
								<tr>
									<td width="9" style="background:#e3f0f9;"><img src="/webmin/images/install/top_gradient_begin.gif" width="9" height="77" alt="" /></td>
		...
		<tr>
			<td width="10" height="10" valign="bottom"><img src="/webmin/images/install/corner_bottom_left.gif" width="10" height="10" alt="" /></td>
			<td width="100%" style="background:#e8e8e8;"></td>
			<td width="10" height="10" valign="bottom"><img src="/webmin/images/install/corner_bottom_right.gif" width="10" height="10" alt="" /></td>
		</tr>
	</table>
