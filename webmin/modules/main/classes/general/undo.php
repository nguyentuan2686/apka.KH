...
class CUndo
{
	...
	function Delete($ID)
	{
		...
		$strSql = "DELETE FROM b_undo WHERE ID=".$ID;
...
window.BXUndoLastChanges = function()
{
	...
	BX.ajax.get(\"/webmin/admin/public_undo.php?undo=".$ID."&".bitrix_sessid_get()."\", false, function(result)
	{
