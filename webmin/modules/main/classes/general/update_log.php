...
$arLogRecs = array();
if (file_exists($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/updater.log")
	&& is_file($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/updater.log")
	&& is_readable($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/updater.log"))
{
	$logf = fopen($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/updater.log", "r");
	while (!feof($logf))
	{
...
$APPLICATION->SetAdditionalCSS("/webmin/themes/".ADMIN_THEME_ID."/sysupdate.css");
