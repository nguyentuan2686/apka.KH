...
require_once($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/classes/general/wizard_util.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/classes/general/wizard_site.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/classes/general/wizard_site_steps.php");
	...
	<head>
		...
		<style type="text/css">
			...
			#step_info
			{
				...
				overflow:hidden;
				background:#F2F5F9 url(/webmin/themes/{$themeID}/images/wizard/wizard.gif) 10px center no-repeat;
