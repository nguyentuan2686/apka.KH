<?
require($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/classes/general/database.php");
	...
	function Query($strSql, $bIgnoreErrors=false, $error_position="")
	{
		...
		if(!$result)
		{
			...
			if(!$bIgnoreErrors)
			{
				...
				elseif(file_exists($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/include/dbquery_error.php"))
					include($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/include/dbquery_error.php");
				else
