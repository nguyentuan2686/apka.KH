...
<?if($this->NavPageNomer > 1):?>
		<td><a href="javascript:<?echo $this->table_id?>.<?=$nav_func_name?>('<?echo $sUrlPath.'?PAGEN_'.$this->NavNum.'=1'.'&amp;SIZEN_'.$this->NavNum.'='.$this->NavPageSize.$sQueryString;?>');"><img src="/webmin/themes/<?echo ADMIN_THEME_ID?>/images/nav/first.gif" class="navfirst" alt="<?echo GetMessage("navigation_first")?>" title="<?echo GetMessage("navigation_first")?>" border="0"></a></td>
		<td><a href="javascript:<?echo $this->table_id?>.<?=$nav_func_name?>('<?echo $sUrlPath.'?PAGEN_'.$this->NavNum.'='.($this->NavPageNomer-1).'&amp;SIZEN_'.$this->NavNum.'='.$this->NavPageSize.$sQueryString;?>');"><img src="/webmin/themes/<?echo ADMIN_THEME_ID?>/images/nav/prev.gif" class="navprev" alt="<?echo GetMessage("navigation_prev")?>" title="<?echo GetMessage("navigation_prev")?>" border="0"></a></td>
<?else:?>
		<td><img src="/webmin/themes/<?echo ADMIN_THEME_ID?>/images/nav/first_dis.gif" class="navfirst" alt="" border="0"></td>
		<td><img src="/webmin/themes/<?echo ADMIN_THEME_ID?>/images/nav/prev_dis.gif" class="navprev" alt="" border="0"></td>
<?endif;?>
		<td><?
...
<?if($this->NavPageNomer < $this->NavPageCount):?>
		<td><a href="javascript:<?echo $this->table_id?>.<?=$nav_func_name?>('<?echo $sUrlPath.'?PAGEN_'.$this->NavNum.'='.($this->NavPageNomer+1).'&amp;SIZEN_'.$this->NavNum.'='.$this->NavPageSize.$sQueryString;?>');"><img src="/webmin/themes/<?echo ADMIN_THEME_ID?>/images/nav/next.gif" class="navnext" alt="<?echo GetMessage("navigation_next")?>" title="<?echo GetMessage("navigation_next")?>" border="0"></a></td>
		<td><a href="javascript:<?echo $this->table_id?>.<?=$nav_func_name?>('<?echo $sUrlPath.'?PAGEN_'.$this->NavNum.'='.$this->NavPageCount.'&amp;SIZEN_'.$this->NavNum.'='.$this->NavPageSize.$sQueryString;?>');"><img src="/webmin/themes/<?echo ADMIN_THEME_ID?>/images/nav/last.gif" class="navlast" alt="<?echo GetMessage("navigation_last")?>" title="<?echo GetMessage("navigation_last")?>" border="0"></a></td>
<?else:?>
		<td><img src="/webmin/themes/<?echo ADMIN_THEME_ID?>/images/nav/next_dis.gif" class="navnext" alt="" border="0"></td>
		<td><img src="/webmin/themes/<?echo ADMIN_THEME_ID?>/images/nav/last_dis.gif" class="navlast" alt="" border="0"></td>
<?endif;?>
		<td>&nbsp;|&nbsp;</td>
<?
