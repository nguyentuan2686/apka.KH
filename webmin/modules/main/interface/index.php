...
$APPLICATION->SetAdditionalCSS("/webmin/themes/".ADMIN_THEME_ID."/index.css".'?'.filemtime($_SERVER["DOCUMENT_ROOT"]."/webmin/themes/".ADMIN_THEME_ID."/index.css"));
...
$bShowSecurity = (file_exists($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/security/install/index.php") && $aGlobalOpt['messages']['security'] <> 'N');
$bShowPerfmon = (file_exists($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/perfmon/install/index.php") && $aGlobalOpt['messages']['perfmon'] <> 'N');
?>
<?
