...
{
	var sURL = '/webmin/admin/fileman_get_xml.php?op=sitetemplateparams&lang='+BXLang+'&site='+BXSite+'&templateID='+templateID;
	...
	BXContextMenu.prototype._Create = function ()
	{
		...
		for(i=0; i<arMenuItems.length; i++)
		{
			if(arMenuItems[i] == 'separator')
			{
				...
				c.innerHTML = '<img src="/webmin/images/1.gif" width="1" height="1"/>';
			}
			else
			{
				r = t.insertRow(-1);
