<?
$module_id = "fileman";
$dicsRelPath = '/webmin/modules/fileman/dictionaries';
...
if($REQUEST_METHOD=="POST" && strlen($Update)>0 && $USER->CanDoOperation('fileman_edit_all_settings') && check_bitrix_sessid())
{
	...
	if(is_dir($_SERVER['DOCUMENT_ROOT'].'/webmin/admin/FCKeditor'))
	{
	...
	if (isset($_POST['user_dics_path']) && $_POST['user_dics_path']!='')
		...
		COption::SetOptionString($module_id, "user_dics_path","/webmin/modules/fileman/u_dics");
...
<tr>
	...
	<tr>
	<td valign="top" width="40%"><label for="use_translit"><?echo GetMessage("FILEMAN_USE_TRANSLITE")?>:</label></td>
	<td valign="top" width="60%">
	...
	<tr>
	<td valign="top" width="40%"><label for="use_translit_google"><?echo GetMessage("FILEMAN_USE_TRANSLITE_GOOGLE")?>:</label></td>
	<td valign="top" width="60%">
...
<?endif;?>
	...
	<tr>
		...
		<td>
			<input type="text" name="user_dics_path" style="width: 100%" value="<? echo COption::GetOptionString($module_id, "user_dics_path", "/webmin/modules/fileman/u_dics")?>">
		</td>
	</tr>
	<tr>
...
?>
	...
	<tr>
		...
		<img src="/webmin/images/1.gif" style="width: 110px; height: 1px;" />
		</td>
	</tr>
...
?>
<?$tabControl->BeginNextTab();?>
<?require_once($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/admin/group_rights2.php");?>

	<tr class="heading">
		<td colspan="2"><a name="limitaccess"></a><?echo GetMessage("fileman_opt_restricted")?></td>
	</tr>
	<tr>
		<td valign="top"><?echo GetMessage("fileman_opt_restricted_rights")?></td>
		<td>
<?
...
?>
			<?if($sSel <> ''):?>
				<?echo GetMessage("fileman_opt_sel")?> <b><?=$sSel?></b><br><br>
			<?endif?>
