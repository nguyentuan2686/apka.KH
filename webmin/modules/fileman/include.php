...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/fileman/lang.php");
include_once($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/admin_tools.php");
include_once($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/fileman/fileman.php");
include_once($_SERVER["DOCUMENT_ROOT"].BX_ROOT."/modules/main/classes/".$GLOBALS["DBType"]."/favorites.php");
include_once($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/fileman/properties.php");
