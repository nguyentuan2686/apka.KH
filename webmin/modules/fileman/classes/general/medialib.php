				...
				if (!window.BXMediaLib)
				{
					if (bLoadJS !== false)
					{
						...
						if (!window.ml_styles_link || !window.ml_styles_link.parentNode)
							window.ml_styles_link = jsUtils.loadCSSFile("/webmin/js/fileman/medialib/medialib.css?v=<?=@filemtime($_SERVER['DOCUMENT_ROOT'].'/webmin/js/fileman/medialib/medialib.css')?>");

						if (!window.jsAjaxUtil)
							jsUtils.loadJSFile("/webmin/js/main/ajax.js?v=<?=@filemtime($_SERVER['DOCUMENT_ROOT'].'/webmin/js/main/ajax.js')?>");

						jsUtils.loadJSFile([
							"/webmin/js/fileman/medialib/common.js?v=<?=@filemtime($_SERVER['DOCUMENT_ROOT'].'/webmin/js/fileman/medialib/common.js')?>",
							"/webmin/js/fileman/medialib/core.js?v=<?=@filemtime($_SERVER['DOCUMENT_ROOT'].'/webmin/js/fileman/medialib/core.js')?>"
						]);
					}
...
if (window.jsUtils)
{
	jsUtils.addEvent(window, 'load', function(){jsUtils.loadJSFile("/webmin/js/main/file_dialog.js?v=<?=@filemtime($_SERVER['DOCUMENT_ROOT'].'/webmin/js/main/file_dialog.js')?>");}, false);
}
<?
		}
	}
...
<?
	...
	function BuildDialog($Params)
	{
		...
		<td class="ml-title-cell">
			<table onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('bxmedialib'));"><tr><td style="width: 10px; padding-left: 3px;"><img class="ml-iconkit ml-dd-dot" src="/webmin/images/1.gif" /></td><td class="ml-diad-title" id="ml_diag_title"><?=GetMessage('ML_MEDIALIB')?></td><td id="bxml_close" class="ml-close" title="<?=GetMessage('ML_CLOSE')?>"><img src="/webmin/images/1.gif"></td></tr></table>
		</td></tr>
		...
		<div class="ml-buttons-cont" id="ml_but_cont">
			<table><tr>
				<td class="ml-left">
				<?if (!$Params['bReadOnly']):?>
				<a id="ml_add_collection" href="javascript:void(0)" title="<?=GetMessage('ML_ADD_COLLECTION_TITLE')?>" class="ml-add-el-link"><img src="/webmin/images/1.gif" /><?=GetMessage('ML_ADD_COLLECTION')?></a>

				<a id="ml_add_item" href="javascript:void(0)" title="<?=GetMessage('ML_ADD_ELEMENT_TITLE')?>" class="ml-add-el-link"><img src="/webmin/images/1.gif" /><?=GetMessage('ML_ADD_ELEMENT')?></a>
				<?endif;?>
				</td><td class="ml-right">
	...
	function BuildAddCollectionDialog($Params)
	{
		...
		<td class="ml-title-cell">
			<table onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('mlsd_coll'));"><tr><td style="width: 10px; padding-left: 3px;"><img class="ml-iconkit ml-dd-dot" src="/webmin/images/1.gif" /></td><td class="ml-diad-title"><span id="mlsd_coll_title"></span></td><td id="mlsd_coll_close" class="ml-close" title="<?=GetMessage('ML_CLOSE')?>"><img src="/webmin/images/1.gif"></td></tr></table>
		</td></tr>
		<tr><td class="ml-content-cell">
	...
	function BuildAddItemDialog($Params)
	{
		...
		<td class="ml-title-cell">
			<table onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('mlsd_item'));"><tr><td style="width: 10px; padding-left: 3px;"><img class="ml-iconkit ml-dd-dot" src="/webmin/images/1.gif" /></td><td class="ml-diad-title"><span id="mlsd_item_title"></span></td><td id="mlsd_item_close" class="ml-close" title="<?=GetMessage('ML_CLOSE')?>"><img src="/webmin/images/1.gif"></td></tr></table>
		</td></tr>
		<tr><td class="ml-content-cell">
...
<style>
	...
	div.mlsd-ch-col{float: left; border: 1px solid #6E8C9B; width: 80px; height: 20px; padding: 0px; overflow: hidden; margin: 2px; position: relative; background: url(/webmin/images/fileman/medialib/group_bg.gif) repeat-x scroll left top;}
	div.mlsd-ch-col span{white-space: nowrap; font-size: 12px !important; display: block; margin: 2px 0 0 2px;}
	div.mlsd-ch-col img.ml-col-del{width: 17px; height: 18px; background-image: url(/webmin/images/fileman/medialib/iconkit.gif); position: absolute; display: none; background-position: 0px -60px; top: 1px; right: 1px; cursor: pointer;}
...
<form name="ml_item_form" action="/webmin/admin/fileman_medialib.php?action=edit_item&<?=bitrix_sessid_get()?>" onsubmit="return parent.oBXMediaLib.EditItemDialogOnsubmit();" method="post" enctype="multipart/form-data"><table class="mlsd-ifrm-tbl">
		<tr><td colSpan="2">
		...
		<tr><td><b><label for="mlsd_item_name"><?=GetMessage('ML_NAME')?>:</label></b><br /><input type="text" id="mlsd_item_name" name="item_name"/></td>
			...
			<div class="mlsd-prev-cont"><span id="mlsd_no_preview"><?= GetMessage('ML_NO_PREVIEW')?></span><img id="mlsd_item_thumb" src="/webmin/images/1.gif" /></div>
...
<?
	...
	function BuildViewItemDialog($Params)
	{
		...
		<td class="ml-title-cell">
			<table onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('mlsd_view_item'));"><tr><td style="width: 10px; padding-left: 3px;"><img class="ml-iconkit ml-dd-dot" src="/webmin/images/1.gif" /></td><td class="ml-diad-title"><?= GetMessage('ML_VIEW_ITEM')?></td><td id="mlsd_viewit_close" class="ml-close" title="<?=GetMessage('ML_CLOSE')?>"><img src="/webmin/images/1.gif"></td></tr></table>
		</td></tr>
		<tr><td class="ml-content-cell">
			...
			<div id="mlsd_item_cont" class="mlvi-img-cnt"><?/*<img id="mlsd_viewit_img" src="/webmin/images/1.gif" />*/?></div>
		</td></tr>
		<tr><td class="ml-buttons-cell">
	...
	function BuildChangeType($Params)
	{
		...
		<td class="ml-title-cell">
			<table onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('mlsd_change_type'));"><tr><td style="width: 10px; padding-left: 3px;"><img class="ml-iconkit ml-dd-dot" src="/webmin/images/1.gif" /></td><td class="ml-diad-title"><?= GetMessage('ML_CHANGE_TYPE_DIALOG')?></td><td id="mlsd_chtype_close" class="ml-close" title="<?=GetMessage('ML_CLOSE')?>"><img src="/webmin/images/1.gif"></td></tr></table>
		</td></tr>
		<tr><td class="ml-content-cell">
			<table class="mlsd-fields-tbl">
				<tr>
	...
	function ShowJS()
	{
		$css_src = '/webmin/js/fileman/medialib/medialib.css';
		$ajax_js = '/webmin/js/main/ajax.js';
		// Append CSS
		?>
		if (!window.ml_styles_link || !window.ml_styles_link.parentNode)
...
div.bx-ml-pnbutton div.bx-pn1{background: url(/webmin/images/fileman/medialib/browse.gif); width: 14px; height: 21px; float: left;}
div.bx-ml-pnbutton div.bx-pn2{background: url(/webmin/images/fileman/medialib/browse.gif) -14px 0; width: 10px; height: 21px; float: left;}
 div.bx-ml-pnbutton div.bx-pressed{background: url(/webmin/images/fileman/medialib/browse.gif) -39px 0;}
	...
	*/
	...
	)
	{
		...
		if(is_array($scaleIcon))
		{
			...
			if($scaleIcon["SCALE"]=="Y")
			{
				...
				if(is_array($fileInput))
					$fileInput["SCALE_HINT_HTML"] = '&nbsp;<img id="'.$fileInput["ID"].'_scale" src="/webmin/images/fileman/medialib/tabs/icon_resized.gif">';
				if(is_array($servInput))
					$servInput["SCALE_HINT_HTML"] = '&nbsp;<img id="'.$servInput["ID"].'_scale" src="/webmin/images/fileman/medialib/tabs/icon_resized.gif">';
				if(is_array($pathInput))
					$pathInput["SCALE_HINT_HTML"] = '&nbsp;<img id="'.$pathInput["ID"].'_scale" src="/webmin/images/fileman/medialib/tabs/icon_resized.gif">';
			}
			else
			{
				$sHintRows .= '<tr valign="top"><td colspan="2" class="bx-grey">'.GetMessage("ML_IF_NO_SCALE_HINT").'</td>';
				if(is_array($fileInput))
					$fileInput["SCALE_HINT_HTML"] = '&nbsp;<img id="'.$fileInput["ID"].'_scale" src="/webmin/images/fileman/medialib/tabs/icon_original.gif">';
				if(is_array($servInput))
					$servInput["SCALE_HINT_HTML"] = '&nbsp;<img id="'.$servInput["ID"].'_scale" src="/webmin/images/fileman/medialib/tabs/icon_original.gif">';
				if(is_array($pathInput))
					$pathInput["SCALE_HINT_HTML"] = '&nbsp;<img id="'.$pathInput["ID"].'_scale" src="/webmin/images/fileman/medialib/tabs/icon_original.gif">';
			}
	...
	function GetTypes($arConfigTypes = array(), $bGetEmpties = false)
	{
		...
		while($arRes = $res->Fetch())
		{
			...
			$typeIcon = "/webmin/images/fileman/medialib/type_".strtolower($arRes["CODE"]).".gif";
			if (!file_exists($_SERVER['DOCUMENT_ROOT'].$typeIcon))
				$typeIcon = "/webmin/images/fileman/medialib/type_default.gif";
			...
			else if (strpos($item['CONTENT_TYPE'], 'video') !== false || in_array($ext, $videoExt))
			{
				...
				$APPLICATION->IncludeComponent(
					...
					array(
						...
						"FILE_DESCRIPTION" => "",
						//"SKIN_PATH" => "/webmin/components/webmin/player/mediaplayer/skins",
						//"SKIN" => "bitrix.swf",
						"WMODE" => "transparent",
...
class CMedialibTabControl
{
	...
	function ShowScript()
	{
		...
		if(!$bShowed)
		{
			CUtil::InitJSCore(array('ajax'));
			?>
			<script type="text/javascript" src="/webmin/js/fileman/medialib/tabs.js<?echo ($bOpera? '':'?'.filemtime($_SERVER["DOCUMENT_ROOT"].'/webmin/js/fileman/medialib/tabs.js'))?>"></script>
			<?
			$bShowed = true;
		}
	}
	...
	function Show()
	{
		...
		for($i = 0; $i < count($this->_tabs); $i++)
		{
			...
			if($i == 0):?>
				<td class="imgtab-sel" nowrap id="<?echo $this->_tabs[$i]["TD_ID"]?>" onclick="<?echo $this->_uniq_id?>.SelectTab(this)"><table class="imgtab-tab" cellspacing="0" cellpadding="0"><tr valign="top"><td><img src="<?echo "/webmin/images/fileman/medialib/tabs/".$this->_tabs[$i]["ICON"].".gif"?>" /></td><td>&nbsp;<div title="<?echo $this->_tabs[$i]["TITLE"]?>"><?echo $this->_tabs[$i]["NAME"]?></div></td></tr></table></td>
		...
		var <?= $this->_uniq_id?>;
		setTimeout(function(){
			<?= $this->_uniq_id?> = new MedialibTabControl('<?= $this->_uniq_id?>', <?echo CUtil::PHPToJSObject($this->_tabs)?> , '<?echo filemtime($_SERVER["DOCUMENT_ROOT"].'/webmin/js/fileman/medialib/tabs.css')?>');
