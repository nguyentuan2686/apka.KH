...
if($USER->CanDoOperation('fileman_view_file_structure'))
{
	...
	{
		case "/webmin/admin/fileman_file_edit.php":
		case "/webmin/admin/fileman_fck_edit.php":
		case "/webmin/admin/fileman_file_view.php":
		case "/webmin/admin/fileman_html_edit.php":
