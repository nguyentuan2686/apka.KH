...
function fetchPropsHelp($componentName_)
{
	...
	$path = $_SERVER["DOCUMENT_ROOT"]."/webmin/components/".$componentName."/help/.tooltips.php";
	$lang_path = $_SERVER["DOCUMENT_ROOT"]."/webmin/components/".$componentName."/lang/".$lang."/help/.tooltips.php";
	global $MESS;
