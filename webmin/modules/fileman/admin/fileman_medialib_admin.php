...
?><script type="text/javascript" src="/webmin/js/fileman/medialib/core_admin.js"></script><?
...
if ($USER->CanDoOperation('fileman_view_all_settings'))
{
	$aContext[] = Array(
		...
		"LINK" => "/webmin/admin/settings.php?mid=fileman&tabControl_active_tab=edit5&lang=".LANGUAGE_ID."&".bitrix_sessid_get(),
...
if (window.jsUtils)
{
	jsUtils.addEvent(window, 'load', function()
	{
		...
		[
			...
			"/webmin/js/fileman/medialib/core_admin.js?v=<?=@filemtime($_SERVER['DOCUMENT_ROOT'].'/webmin/js/fileman/medialib/core_admin.js')?>"
		],
		function()
		{
...
<div class="ml-cont">
	...
	<div class="ml-search-res-cont" id="ml_search_res_cont_par">
		<div class="ml-coll-title mlcolllevel-0" title="<?= GetMessage('ML_SEARCH_RESULT')?>">
			<img class="ml-col-icon ml-col-icon-closed" src="/webmin/images/1.gif" id="ml_srch_res_flip"/>
