...
<tr>
	...
	<table class="internal">
		<tr class="heading">
			...
			<tr valign="top">
				<td>
					[<a href="/webmin/admin/group_edit.php?ID=<?= $arGroup['ID']?>&lang=<?=LANGUAGE_ID?>"><?= $arGroup['ID']?></a>]&nbsp;<?= $arGroup['NAME']?>:
				</td>
				<td>
...
$tabControl->Buttons(
	array(
		"disabled" => false,
		"back_url" => "fileman_medialib_admin.php?".$addUrl."&lang=".LANGUAGE_ID."&".webmin_sessid_get()
	)
);
?>
