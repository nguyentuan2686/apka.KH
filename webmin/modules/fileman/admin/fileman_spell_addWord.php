...
require($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/fileman/admin/fileman_spellChecker.php");
...
$path = replacer($_SERVER["DOCUMENT_ROOT"].COption::GetOptionString('fileman', "user_dics_path", "/webmin/modules/fileman/u_dics"));
if (!is_dir($path))
