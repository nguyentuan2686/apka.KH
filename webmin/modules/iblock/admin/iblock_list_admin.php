...
while($arRes = $rsData->NavNext(true, "f_"))
{
	...
	if($f_TYPE=="E")
	{
		...
		{
			$lamp = "/webmin/images/workflow/".$lockStatus.".gif";
			if($lockStatus=="green")
...
<?if($bWorkFlow || $bBizproc):?>
	...
	<tr><td><img src="/webmin/images/workflow/green.gif" width="14" height="14" border=0 alt=""></td><td><font class="legendtext"> - <?echo GetMessage("IBLIST_A_GREEN_ALT")?></font></td></tr>
	<tr><td><img src="/webmin/images/workflow/yellow.gif" width="14" height="14" border=0 alt=""></td><td><font class="legendtext"> - <?echo GetMessage("IBLIST_A_YELLOW_ALT")?></font></td></tr>
	<tr><td><img src="/webmin/images/workflow/red.gif" width="14" height="14" border=0 alt=""></td><td><font class="legendtext"> - <?echo GetMessage("IBLIST_A_RED_ALT")?></font></td></tr>
	</table>
	<?echo EndNote();?>
<?endif;?>
<?
