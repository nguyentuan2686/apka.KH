...
<?if($bWorkFlow || $bBizproc):?>
	...
	<tr><td><img src="/webmin/images/workflow/green.gif" width="14" height="14" border=0 alt=""></td><td><font class="legendtext"> - <?echo GetMessage("IBLOCK_GREEN_ALT")?></font></td></tr>
	<tr><td><img src="/webmin/images/workflow/yellow.gif" width="14" height="14" border=0 alt=""></td><td><font class="legendtext"> - <?echo GetMessage("IBLOCK_YELLOW_ALT")?></font></td></tr>
	<tr><td><img src="/webmin/images/workflow/red.gif" width="14" height="14" border=0 alt=""></td><td><font class="legendtext"> - <?echo GetMessage("IBLOCK_RED_ALT")?></font></td></tr>
	</table>
	<?echo EndNote();?>
<?endif;?>
<?
