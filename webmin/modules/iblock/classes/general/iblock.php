...
class CAllIBlock
{
	...
	function AddPanelButtons($mode, $componentName, $arButtons)
	{
		...
		$arImages = array(
			"add_element" => (defined("PANEL_ADD_ELEMENT_BTN")) ? PANEL_ADD_ELEMENT_BTN : "/webmin/images/iblock/icons/new_element.gif",
			"edit_element" => (defined("PANEL_EDIT_ELEMENT_BTN")) ? PANEL_EDIT_ELEMENT_BTN : "/webmin/images/iblock/icons/edit_element.gif",
			"edit_iblock" => (defined("PANEL_EDIT_IBLOCK_BTN")) ? PANEL_EDIT_IBLOCK_BTN : "/webmin/images/iblock/icons/edit_iblock.gif",
			"history_element" => (defined("PANEL_HISTORY_ELEMENT_BTN")) ? PANEL_HISTORY_ELEMENT_BTN : "/webmin/images/iblock/icons/history.gif",
			"edit_section" => (defined("PANEL_EDIT_SECTION_BTN")) ? PANEL_EDIT_SECTION_BTN : "/webmin/images/iblock/icons/edit_section.gif",
			"add_section" => (defined("PANEL_ADD_SECTION_BTN")) ? PANEL_ADD_SECTION_BTN : "/webmin/images/iblock/icons/new_section.gif",
			"element_list" => "/webmin/themes/.default/icons/iblock/mnu_iblock_el.gif",
			"section_list" => "/webmin/themes/.default/icons/iblock/mnu_iblock_sec.gif",
		);
		...
		if(count($arButtons[$mode]) > 0)
		{
			...
			if(strlen($componentName) <= 0 && function_exists("debug_backtrace"))
			{
				...
				foreach($arTrace as $i => $arCallInfo)
				{
					if(array_key_exists("file", $arCallInfo))
					{
						...
						if(preg_match("#.*/webmin/components/(.+?)/(.+?)/#", $file, $match))
						{
			...
			$arPanelButton = array(
				"SRC" => "/webmin/images/iblock/icons/iblock.gif",
				"ALT" => $componentName,
				"TEXT" => $componentName,
				"MAIN_SORT" => 300,
				"SORT" => 30,
	...
	{
		// $arImages = array(
			// "add_element" => "/webmin/images/iblock/icons/new_element.gif",
			// "edit_element" => "/webmin/images/iblock/icons/edit_element.gif",
			// "edit_iblock" => "/webmin/images/iblock/icons/edit_iblock.gif",
			// "history_element" => "/webmin/images/iblock/icons/history.gif",
			// "edit_section" => "/webmin/images/iblock/icons/edit_section.gif",
			// "add_section" => "/webmin/images/iblock/icons/new_section.gif",
			// "element_list" => "/webmin/themes/.default/icons/iblock/mnu_iblock_el.gif",
			// "section_list" => "/webmin/themes/.default/icons/iblock/mnu_iblock_sec.gif",
		// );
	...
	function GetPanelButtons($IBLOCK_ID=0, $ELEMENT_ID=0, $SECTION_ID=0, $arOptions=array())
	{
		...
		{
			$url = "/webmin/admin/iblock_element_edit.php?type=".$arIBlock["IBLOCK_TYPE_ID"]."&lang=".LANGUAGE_ID."&IBLOCK_ID=".$IBLOCK_ID."&filter_section=".$SECTION_ID."&IBLOCK_SECTION_ID=".$SECTION_ID."&return_url=".UrlEncode($return_url);
			...
			if($ELEMENT_ID > 0)
			{
				$url = "/webmin/admin/iblock_element_edit.php?type=".$arIBlock["IBLOCK_TYPE_ID"].$s."&lang=".LANGUAGE_ID."&IBLOCK_ID=".$IBLOCK_ID."&ID=".$ELEMENT_ID."&filter_section=".$SECTION_ID."&return_url=".UrlEncode($return_url);
				...
				if($bWorkflow)
				{
					$url = "/webmin/admin/iblock_history_list.php?type=".$arIBlock["IBLOCK_TYPE_ID"]."&lang=".LANGUAGE_ID."&IBLOCK_ID=".$IBLOCK_ID."&ELEMENT_ID=".$ELEMENT_ID."&filter_section=".$SECTION_ID."&return_url=".UrlEncode($return_url);
					$arButton = array(
			...
			if( ($iblock_permission > "U") && ($ELEMENT_ID <= 0) && $bSectionButtons)
			{
				...
				if(($arIBTYPE = $rsIBTYPE->Fetch()) && ($arIBTYPE["SECTIONS"] == "Y"))
				{
					if($SECTION_ID > 0)
					{
						...
						$url = "/webmin/admin/iblock_section_edit.php?ID=". $SECTION_ID."&type=".$arIBlock["IBLOCK_TYPE_ID"]."&lang=".LANGUAGE_ID. "&IBLOCK_ID=". $IBLOCK_ID."&filter_section=".$SECTION_ID."&return_url=".UrlEncode($return_url);
					...
					$url = "/webmin/admin/iblock_section_edit.php?type=".$arIBlock["IBLOCK_TYPE_ID"]."&lang=".LANGUAGE_ID."&IBLOCK_ID=".$IBLOCK_ID."&IBLOCK_SECTION_ID=".$SECTION_ID."&filter_section=".$SECTION_ID."&return_url=".UrlEncode($return_url);
		...
		if( ($IBLOCK_ID > 0) && ($iblock_permission >= $max_permission) )
		{
			...
			if($SECTION_ID > 0)
				$url = "/webmin/admin/".CIBlock::GetAdminElementListLink($IBLOCK_ID , array('find_section_section'=>$SECTION_ID));
			else
				$url = "/webmin/admin/".CIBlock::GetAdminElementListLink($IBLOCK_ID , array('find_el_y'=>'Y'));
			...
			$url = "/webmin/admin/".CIBlock::GetAdminSectionListLink($IBLOCK_ID, array('find_section_section'=>$SECTION_ID));
			$arButton = array(
			...
			{
				$url = "/webmin/admin/iblock_edit.php?type=".$arIBlock["IBLOCK_TYPE_ID"]."&lang=".LANGUAGE_ID."&ID=".$IBLOCK_ID."&return_url=".UrlEncode($return_url);
				$arButton = array(
