...
if(isset($_REQUEST["test"]) && $_REQUEST["test"] === "Y")
{
	...
	require_once($_SERVER["DOCUMENT_ROOT"]."/webmin/modules/main/include/epilog_after.php");
			...
			<?else:?>
				...
				<td><?echo GetMessage("PERFMON_PANEL_MANAGED_CACHE_REC", array(
					"#file#" => (
						...
						"<a href=\"".'/webmin/admin/fileman_file_edit.php?lang='.LANGUAGE_ID.'&amp;full_src=Y&amp;path='.urlencode(BX_PERSONAL_ROOT.'/php_interface/dbconn.php').'&amp;back_url='.urlencode('/webmin/admin/security_panel.php?lang='.LANGUAGE_ID)."\">dbconn.php</a>":
						"dbconn.php"
					),
				));?>
				</td>
