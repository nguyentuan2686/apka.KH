...
var insert_wa = [
	'BXButton', 
	{
		...
		handler : function ()
		{
			this.pMainObj.insertHTML("<img src=\"/webmin/images/fileman/htmledit2/work_area.gif\" id=\"" + this.pMainObj.SetBxTag(false, {tag: 'work_area'}) + "\"/>");
		}
	}
];
...
{
	str = str.replace(/#WORK_AREA#/ig, '<img src="/webmin/images/fileman/htmledit2/work_area.gif" id="' + pMainObj.SetBxTag(false, {tag: 'work_area'}) + '"/>');
	return str;
}
...
{
	bxTag = this.pParser.pMainObj.GetBxTag(node.id);
	if(bxTag && bxTag.tag && bxTag.tag == '')
		return '#WORK_AREA#';
