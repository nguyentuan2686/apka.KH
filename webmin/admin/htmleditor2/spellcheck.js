...
BXSpellChecker.prototype.spellCheck = function()
{
	if (this.wordList.length > 0)
	{
		...
		var url = "/webmin/admin/fileman_spell_checking.php?BXLang="+this.BXLang+"&useCustomSpell="+this.useCustomSpell+"&usePspell="+this.usePspell;
...
BXSpellChecker.prototype.addWord = function()
{
	...
	var url = "/webmin/admin/fileman_spell_addWord.php?BXLang="+this.BXLang+"&useCustomSpell="+this.useCustomSpell+"&usePspell="+this.usePspell;
