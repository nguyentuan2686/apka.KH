...
arButtons['tabsection'] = ['BXButton',
	{
		...
		src : '/webmin/images/fileman/htmledit2/insert_tabsection.gif',
		name : 'Вставить область закладок',
		handler : function ()
		{
			this.bNotFocus = true;
			this.pMainObj.insertHTML(
				'<img src="/webmin/images/1.gif" style="background-image: url(/webmin/images/fileman/htmledit2/tab_section_begin.gif); height: 17px; width: 100%" __bxtagname="begin_tabsection" __bxcontainer="" /><div _moz_editor_bogus_node="on"></div>' +
				'<br />' +
				'<br />' +
				'<img src="/webmin/images/1.gif" style="background-image: url(/webmin/images/fileman/htmledit2/tab_section_end.gif); height: 17px; width: 100%" __bxtagname="end_tabsection" __bxcontainer="" /><div _moz_editor_bogus_node="on"></div>'
			);
...
arButtons['tab'] = ['BXButton',
	{
		id : 'tab',
		codeEditorMode : false,
		src : '/webmin/images/fileman/htmledit2/insert_tab.gif',
...
'</table>';
	...
	var OnSave = function(t)
	{
		...
		BXSelectRange(oPrevRange, pObj.pMainObj.pEditorDocument, pObj.pMainObj.pEditorWindow);
		pObj.pMainObj.insertHTML('<img src="/webmin/images/1.gif" style="background-image: url(/webmin/images/fileman/htmledit2/tab.gif); height: 20px; width: 100%" __bxtagname="tab" __bxcontainer="'+bxhtmlspecialchars(BXSerialize({name : name, id : id}))+'" /><div _moz_editor_bogus_node="on"></div>');
...
function BitrixRU_ContentParser(str)
{
	...
	str = str.replace(/<tabsection>/ig, function(str){
		window.bBitrixTabs = true;
		return '<img src="/webmin/images/1.gif" style="background-image: url(/webmin/images/fileman/htmledit2/tab_section_begin.gif); height: 17px; width: 100%; display:block;" __bxtagname="begin_tabsection" __bxcontainer="" /><div _moz_editor_bogus_node="on"></div>';
	});
	str = str.replace(/<\/tabsection>/ig, function(str)
		{
			return '<img src="/webmin/images/1.gif" style="background-image: url(/webmin/images/fileman/htmledit2/tab_section_end.gif); height: 17px; width: 100%" __bxtagname="end_tabsection" __bxcontainer="" /><div _moz_editor_bogus_node="on"></div>';
		}
	);
	str = str.replace(/<tab\s{1}(?:\s|\S)*?>/ig, function(str, b1)
		{
			...
			return '<img src="/webmin/images/1.gif" style="background-image: url(/webmin/images/fileman/htmledit2/tab.gif); height: 20px; width: 100%" __bxtagname="tab" __bxcontainer="'+bxhtmlspecialchars(BXSerialize({name : name, id : id}))+'" /><div _moz_editor_bogus_node="on"></div>';
		}
	);

	str = str.replace(/<\?\$APPLICATION->IncludeComponent\(\s*?("|')\S*?webmin\.comment\1(\S|\s)*?\?>/ig, function(str)
		{
			var groups = '';
