...
BXDialogTree.prototype =
{
	...
	{
		this.arIconList = {
			folder : '/webmin/images/main/file_dialog/icons/folder.gif',
			folderopen : '/webmin/images/main/file_dialog/icons/folderopen.gif',
			plus : '/webmin/images/main/file_dialog/icons/plus.gif',
			minus : '/webmin/images/main/file_dialog/icons/minus.gif',
			dot : '/webmin/images/main/file_dialog/icons/dot.gif'
		};
		this.arDirConts = {};
	},
...
BXDialogWindow.prototype =
{
	Init: function(path)
	{
		...
		this.iconsPath = '/webmin/images/main/file_dialog/icons/types/';
		this.arIcons =
		{
	...
	DisplayElList_detail: function(arElements)
	{
		...
		fill_innerHTML();
		var arr_img = "<img src='/webmin/images/main/file_dialog/arrow_" + (oBXDialogWindow.sort_order == 'asc' ? 'up' : 'down') + ".gif'>";
	...
	OnContextMenu: function(e)
	{
		...
		if (oEl.permission.del || oEl.permission.ren)
		{
			...
			if (oEl.permission.ren)
			{
				arItems.push({
					id : 'rename',
					src : '/webmin/images/main/file_dialog/rename.gif',
			...
			if (oEl.permission.del)
			{
				...
				arItems.push({
					id : 'delete',
					src : '/webmin/images/main/file_dialog/delete.gif',
...
BXDialogTabs.prototype =
{
	...
	DisplayTabs: function()
	{
		...
		{
			var _style = "background-image: url(/webmin/images/main/file_dialog/tabs/tab_icons.gif);";
			oCell.innerHTML = '<img class=" '+className+'" src="/webmin/images/1.gif" height="27px" width="'+width+'px" style="'+_style+'"/>';
		}
