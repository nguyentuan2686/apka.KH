...
var jsAjaxUtil = {
	...
	{
		if (
			/\/webmin\/js\/main\/ajax.js$/i.test(script_src)
			||
			/\/webmin\/js\/main\/core\/core.js$/i.test(script_src)
		) return;
	...
	checkRedirectFinish: function(param_name, param_value)
	{
		...
		jsEvent.addEvent(window, 'load', function () 
		{
			...
			if (current_hash.substring(0, 5) == 'view/')
			{
				...
				var url = '/webmin/tools/ajax_redirector.php?hash=' + current_hash; //jsAjaxHistory.urlencode(current_hash);
