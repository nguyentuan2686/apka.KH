...
Create: function()
{
	...
	this.arrowsContDiv.appendChild(jsUtils.CreateElement('IMG', {src: '/webmin/images/1.gif', className: 'bxc-min-arr-cont bxc-iconkit-a'}));
	this.arrowsContDiv.appendChild(jsUtils.CreateElement('IMG', {src: '/webmin/images/1.gif', className: 'bxc-hour-arr-cont bxc-iconkit-a'}));
...
CreateControls: function()
{
	...
	// Close button
	var closeImg = jsUtils.CreateElement('IMG', {src: '/webmin/images/1.gif', className: 'bxc-close bxc-iconkit-c', title: this.MESS.Close});
	...
	{
		this.AmPm = jsUtils.CreateElement('IMG', {src: '/webmin/images/1.gif', className: 'bxc-iconkit-c bxc-am', title: 'a.m.'});
...
CreateSelect: function(arValues, step, title)
{
	...
	c = r.insertCell(-1);
	c.appendChild(jsUtils.CreateElement('IMG', {src: '/webmin/images/1.gif', className: 'bxc-slide-up bxc-iconkit-c'}));
	c.title = this.MESS.Up;
	c.className = 'bxc-pointer';
	c.onmousedown = function(){spinStart(step)};
	c = tbl.insertRow(-1).insertCell(-1);
	c.appendChild(jsUtils.CreateElement('IMG', {src: '/webmin/images/1.gif', className: 'bxc-slide-down bxc-iconkit-c'}));
