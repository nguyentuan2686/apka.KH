			...
			Parse: function(sName, sContent, pLEditor)
			{
				return sContent.replace(
					...
					function(sContent, name)
					{
						...
						return '<img id="' + name + '" src="/webmin/images/1.gif" style="background-image: url(/webmin/images/fileman/light_htmledit/lhe_iconkit.gif); background-position: -260px 0; height: 20px; width: 20px"  __bxtagname="' + sName + '" />';
					}
				);
...
LHEButtons['DeleteLink'] = {
	...
	handler : function(pBut)
	{
		...
		if (jsUtils.bIsIE && !p)
		{
			...
			{
				pBut.pLEditor.InsertHTML('<img id="bx_lhe_temp_bogus_node" src="/webmin/images/1.gif" _moz_editor_bogus_node="on" style="border: 0px !important;"/>');
		...
		obj:
		{
			Parse: function(sName, sContent, pLEditor)
			{
				...
				var ReplaceWMV = function(str, b1, b2, b3, b4)
				{
					...
					prPath = JSConfig.image || '/webmin/images/fileman/light_htmledit/video.gif';
				...
				var ReplaceFLV = function(str, attr)
				{
					...
					prPath = arFlashvars.image || '/webmin/images/fileman/light_htmledit/video.gif';
			...
			UnParse: function(sName, pNode, pLEditor)
			{
				...
				{
					str = '<embed src="/webmin/components/webmin/player/mediaplayer/player.swf" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" pluginspage="http:/' + '/www.macromedia.com/go/getflashplayer" ';
					str += 'id="' + videoId + '" ';
					if (arVidConf.WMode)
				...
				{
					str = '<script type="text/javascript" src="/webmin/components/webmin/player/wmvplayer/silverlight.js" /></script>' +
				'<script type="text/javascript" src="/webmin/components/webmin/player/wmvplayer/wmvplayer.js"></script>' +
				'<div id="' + videoId + '">WMV Player</div>' +
				'<script type="text/javascript">new jeroenwijering.Player(document.getElementById("' + videoId + '"), "/webmin/components/webmin/player/wmvplayer/wmvplayer.xaml", {';
